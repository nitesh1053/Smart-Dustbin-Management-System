...
public class driver_login extends javax.swing.JFrame {
    ...
    van_incharge st = new van_incharge();
    public driver_login() {
        initComponents();
    ...
    van_incharge incharge = new van_incharge();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 280, 250));

        jLabel4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("SMART DUSTBIN MANAGEMENT");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 350, 30));
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
       ...
       for (int i = 0; i < se_project.SE_Project.vanlist.size(); i++) { 
           if(se_project.SE_Project.vanlist.get(i).username.equals(USERNAME1))
           {       
               if(se_project.SE_Project.vanlist.get(i).password.equals(PASSWORD1))
               {
                   flag = 1;
               }
           }
